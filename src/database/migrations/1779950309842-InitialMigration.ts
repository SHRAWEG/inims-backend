...
export class InitialMigration1779950309842 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_system_role_enum" AS ENUM('SUPER_ADMIN', 'ADMIN')`);
        ...
        await queryRunner.query(`CREATE TABLE "age_groups" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "is_active" boolean NOT NULL DEFAULT true, "name" jsonb NOT NULL, CONSTRAINT "PK_74553a8c46fc414046f0fd02c70" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."audit_logs_action_enum" AS ENUM('CREATE', 'UPDATE', 'DELETE', 'SOFT_DELETE', 'RESTORE', 'LOGIN_SUCCESS', 'LOGIN_FAILURE', 'LOGOUT', 'PASSWORD_CHANGE')`);
        ...
        await queryRunner.query(`ALTER TABLE "msnp_indicator_configurations" ADD CONSTRAINT "FK_06c6c1bd78394bb710e8ea6543f" FOREIGN KEY ("indicator_id") REFERENCES "msnp_indicators"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "msnp_indicator_configurations" ADD CONSTRAINT "FK_17af56e7e356bda9d3c6d26de6e" FOREIGN KEY ("sector_id") REFERENCES "sectors"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "msnp_indicator_configurations" ADD CONSTRAINT "FK_584712a629194dfe983bb9bd262" FOREIGN KEY ("type_id") REFERENCES "types"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "msnp_indicator_configurations" ADD CONSTRAINT "FK_26c45eda03eca4d4c996bd99514" FOREIGN KEY ("role_id") REFERENCES "roles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "msnp_indicator_targets" ADD CONSTRAINT "FK_2d7c9813e7015ffa0cf8a7fbde9" FOREIGN KEY ("indicator_config_id") REFERENCES "msnp_indicator_configurations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "msnp_indicator_targets" ADD CONSTRAINT "FK_36b80835c3accfc6e0e304d9685" FOREIGN KEY ("fiscal_year_id") REFERENCES "fiscal_years"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "msnp_indicator_data" ADD CONSTRAINT "FK_d8f96ce11aa334bbb24deb60ff5" FOREIGN KEY ("indicator_config_id") REFERENCES "msnp_indicator_configurations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "msnp_indicator_data" ADD CONSTRAINT "FK_d487f584890d0ca841b019edce9" FOREIGN KEY ("fiscal_year_id") REFERENCES "fiscal_years"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "msnp_indicator_data" ADD CONSTRAINT "FK_10b37cd4d9ee43288db847a32d3" FOREIGN KEY ("submitted_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "msnp_indicator_data" DROP CONSTRAINT "FK_10b37cd4d9ee43288db847a32d3"`);
        await queryRunner.query(`ALTER TABLE "msnp_indicator_data" DROP CONSTRAINT "FK_d487f584890d0ca841b019edce9"`);
        await queryRunner.query(`ALTER TABLE "msnp_indicator_data" DROP CONSTRAINT "FK_d8f96ce11aa334bbb24deb60ff5"`);
        await queryRunner.query(`ALTER TABLE "msnp_indicator_targets" DROP CONSTRAINT "FK_36b80835c3accfc6e0e304d9685"`);
        await queryRunner.query(`ALTER TABLE "msnp_indicator_targets" DROP CONSTRAINT "FK_2d7c9813e7015ffa0cf8a7fbde9"`);
        await queryRunner.query(`ALTER TABLE "msnp_indicator_configurations" DROP CONSTRAINT "FK_26c45eda03eca4d4c996bd99514"`);
        await queryRunner.query(`ALTER TABLE "msnp_indicator_configurations" DROP CONSTRAINT "FK_584712a629194dfe983bb9bd262"`);
        await queryRunner.query(`ALTER TABLE "msnp_indicator_configurations" DROP CONSTRAINT "FK_17af56e7e356bda9d3c6d26de6e"`);
        await queryRunner.query(`ALTER TABLE "msnp_indicator_configurations" DROP CONSTRAINT "FK_06c6c1bd78394bb710e8ea6543f"`);
